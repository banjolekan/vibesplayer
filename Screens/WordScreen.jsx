  ...
  return (
    <View style={styles.container}>
      <View style={styles.blueBackground}>
        <Text style={{fontSize:40, fontWeight:'600', color: 'white'}}>Word to pdf</Text>
      </View>
    ...
    padding: 15,}}>
      ...
      <View style={{  backgroundColor: "white",borderRadius: 15, marginTop: 10, padding: 14, borderColor: '#ccc',borderWidth: 1,padding: 30,marginTop:50
    }} >
